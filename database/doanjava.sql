...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 19, 2020 lúc 04:15 PM
...
(4, 'Kinh đô Mondelez', '123456789', 'kinhdo@gmail.com', 'số 26 đường số 8 KCN Singapore, An Phú, Thuận An, Bình Dương', 1),
...
(4, 'Đoàn', 'Quốc Hùng', '0123456789', 'hung@gmail.com', 'Nam', 'Developer', '87cfe89dd6e63c2ae0a206cecc4c3b64', 2, 1),
...
(8, 'Trẻ', 'Con', '0123456789', 'tre@gmail.com', 'Nữ', 'phá', '7aad741bd57b7c9c5c445e161353c3ea', 2, 1),
(9, 'a', 'b', '0987654321', 'gaga@gmail.com', 'nam', 'gh', 'd16fb36f0911f878998c136191af705e', 2, 1);
...
(1, 'Bánh cua mini ABC', 50, 16000, 'Bánh', 1),
(2, 'Bánh bao khoai môn', 0, 23000, 'Bánh', 1),
(3, 'Coca Cola', 0, 9000, 'Nước uống', 1),
...
(9, 'Mì gói Hảo Hảo', 15, 3500, 'Thực phẩm đóng gói', 1),
...
--
ALTER TABLE `hoadon`
  MODIFY `ID_HD` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `phieunhap`
  MODIFY `ID_PN` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
